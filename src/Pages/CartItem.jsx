...
import { decreaseQuantity, increaseQuantity, removeFromCart } from "../Redux/features/products/carts/cartSlice.js"
        ...
        <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
          ...
          <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
            <div className="flex items-center border-gray-100">
              ...
              {/* Quantity Display */}
              <input
                className="h-8 w-8 border bg-white text-center text-xs outline-none text-accent"
                type="number"
                value={quantity}
                readOnly
              />
            ...
            <div className="flex items-center space-x-4">
              <p className="text-sm text-accent">${(price * quantity).toFixed(2)}</p>
              <button
