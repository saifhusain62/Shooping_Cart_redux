  ...
  return (
    <div className="mt-6 rounded-lg border bg-white p-6 shadow-md md:mt-0">
      ...
      <div className="flex justify-between">
        ...
        <div className="">
          <p className="mb-1 text-lg font-bold text-accent">${subTotal > 0 ? totalBillings(subTotal) : 0} USD</p>
          <p className="text-sm text-gray-700">including VAT</p>
        </div>
      </div>
      <button className="mt-6 w-full rounded-md bg-accent py-1.5 font-medium text-blue-50 hover:bg-blue-600">
        Check out
      </button>
    </div>
  );
